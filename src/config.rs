...
lazy_static::lazy_static! {
    ...
    pub static ref PROD_RENDEZVOUS_SERVER: RwLock<String> = RwLock::new("remote.infinitek.it".to_owned());
    pub static ref EXE_RENDEZVOUS_SERVER: RwLock<String> = Default::default();
    pub static ref APP_NAME: RwLock<String> = RwLock::new("Remotek".to_owned());
    ...
    pub static ref OVERWRITE_SETTINGS: RwLock<HashMap<String, String>> = RwLock::new(HashMap::from([(keys::OPTION_ALLOW_AUTO_UPDATE.to_owned(), "N".to_owned()), (keys::OPTION_APPROVE_MODE.to_owned(), "click".to_owned()), ("2fa".to_owned(), "".to_owned()), (keys::OPTION_ACCESS_MODE.to_owned(), "".to_owned()), (keys::OPTION_ENABLE_LAN_DISCOVERY.to_owned(), "N".to_owned()), (keys::OPTION_ENABLE_RECORD_SESSION.to_owned(), "N".to_owned()), (keys::OPTION_ALLOW_AUTO_RECORD_INCOMING.to_owned(), "N".to_owned()), (keys::OPTION_ENABLE_PRIVACY_MODE.to_owned(), "N".to_owned()), (keys::OPTION_ENABLE_CAMERA.to_owned(), "N".to_owned())]));
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["remote.infinitek.it"];
pub const RS_PUB_KEY: &str = "aaoyRbifrm0xEM3cc0gdtfgF4ckbPDMnNIVrttKQdvs=";
